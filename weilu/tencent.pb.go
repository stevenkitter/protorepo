...
func (*WXAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_02409592e6ee1ecc, []int{0}
}
...
func (m *WXAuthRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WXAuthRequest.Merge(m, src)
}
...
func (*WXAuthResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_02409592e6ee1ecc, []int{1}
}
...
func (m *WXAuthResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WXAuthResp.Merge(m, src)
}
...
func init() { proto.RegisterFile("weilu/tencent.proto", fileDescriptor_02409592e6ee1ecc) }

var fileDescriptor_02409592e6ee1ecc = []byte{
	...
	0xe2, 0x82, 0x24, 0x36, 0xb0, 0x23, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x6e, 0x74, 0xfa,
	0xc2, 0xd3, 0x00, 0x00, 0x00,
}
